...
const Classes = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-5 pb-10">
      <Helmet>
        <title>RMT MUSIC | All Classes</title>
      </Helmet>
      ...
      <div className="grid md:grid-cols-4 gap-10">
        {approvedClasses.map((item) => (
          <div key={item._id}>
            <div
              className={`bg-white rounded-lg shadow-sm shadow-[#F5A207] transition duration-300 ease-in-out hover:scale-110 ${
            ...
            >
              ...
              <button
                className="bg-[#F5A207] w-full text-white px-4 py-2 rounded-md hover:bg-[#C88205]"
