...
const Register = () => {
  ...
  return (
    <div className="flex justify-center items-center py-20">
      <Helmet>
        <title>RMT MUSIC | Create an account</title>
      </Helmet>
      <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10  border border-[#F5A207] text-gray-900">
        ...
        <p className="px-6 text-sm text-center ">
          ...
          <Link
            to="/login"
            className="hover:underline hover:text-[#F5A207] text-gray-600"
          >
            Login
          </Link>
          .
