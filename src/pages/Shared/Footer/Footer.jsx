      ...
      <div>
        <div className="md:flex gap-5 justify-between">
          <div className="mb-5 md:mb-5">
            <h1 className="text-2xl font-bold">RMT <span className="text-black">MUSIC</span></h1>
        ...
        <small>Copyright © 2025 All Rights Reserved by RMT MUSIC</small>
        </div>
    </div>
  );
};
