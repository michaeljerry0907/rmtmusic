...
const Instructors = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto pb-10 px-10">
      <Helmet>
        <title>RMT MUSIC | All Instructor</title>
      </Helmet>
        ...
        {instructors?.map((item) => (
          ...
          <div className="wrapper transition duration-300 ease-in-out hover:scale-110  antialiased text-gray-900">
            <div>
              <img
                src={item.photo}
                className="w-full object-cover object-center rounded-lg shadow-md shadow-[#F5A207]"
              />

              <div className="relative px-4 -mt-10  ">
                <div className="bg-white border-2 border-[#F5A207]  p-6 rounded-lg shadow-lg">
