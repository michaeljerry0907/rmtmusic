...
const MusicalInstrument = () => {
  return (
    <div className="max-w-screen-xl px-10 mx-auto py-10">
      <div>
        <h1 className="text-4xl font-bold my-14 text-center">Musical <span className="text-[#F5A207]">Instrument</span></h1>
        <div>
          <div className="md:grid grid-cols-3 gap-32">
            <div
              className="flex flex-col gap-3 items-center border-2 border-[#F5A207] p-2 rounded hover:bg-[#F5A207] hover:text-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 cursor-pointer mb-5 md:mb-0 shadow-md shadow-[#F5A207]"
              data-aos="fade-up"
