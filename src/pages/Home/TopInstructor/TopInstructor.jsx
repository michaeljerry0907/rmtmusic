...
const TopInstructor = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-5">
      <h1 className="text-4xl font-bold my-14 text-center">Popular <span className="text-[#F5A207]">Instructors</span></h1>
      <div className="grid md:grid-cols-3 gap-10" data-aos="fade-up"
     data-aos-anchor-placement="top-bottom">
        {slicedInstructors?.map((item) => (
          <div key={item._id}>
            <div className="max-w-sm rounded overflow-hidden shadow-lg hover:shadow-xl hover:shadow-[#F5A207] hover:rotate-3 transform transition-all duration-300">
