...
const Dashboard = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>RMT MUSIC | Dashboard</title>
      </Helmet>
      <div className="flex">
        <input
          type="checkbox"
        ...
        <div className="md:ml-72  w-full h-auto ">
          <div className="md:mt-20 pb-5 border-b-2 border-[#F5A207]">
            <h1 className="text-center font-bold text-3xl">
              Hello <span className="text-[#F5A207]">{user.displayName}</span>{" "}
        ...
        >
          <div className="px-6 py-4 border-2 border-[#F5A207] h-screen">
            <div className="flex items-center gap-1 font-bold">
            <img src={logo} className="py-5 h-20" alt="RMT MUSIC" />
            </div>
            <hr />
            <div className="flex flex-col items-center gap-3">
              <img
                src={user.photoURL}
                className="border-4 border-[#F5A207] rounded-full h-32 w-32"
                alt=""
              />
